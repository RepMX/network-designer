...
export function ContactButton() {
  ...
  return (
    <Button
      ...
      className="bg-primary text-primary-foreground hover:bg-primary/90 hover:shadow-lg hover:shadow-primary/25 gap-2.5 group whitespace-nowrap h-11 px-3 w-40 inline-flex items-center justify-end transition-all duration-200"
    >
      {copied ? (
        <>
          Email Copied!
