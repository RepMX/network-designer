...
export function ContactButton() {
  ...
  return (
    <Button
      ...
      className="bg-primary text-primary-foreground hover:bg-primary/90 hover:shadow-lg hover:shadow-primary/25 gap-2.5 group whitespace-nowrap h-11 pl-3 pr-0 w-[180px] inline-flex items-center justify-center transition-all duration-200"
    >
      {copied ? (
        <>
          Email Copied!
